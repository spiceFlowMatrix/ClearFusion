...
You do this by clicking on the **SET GAIN/LOSS ACCOUNTS** button in the [Calculator Configuration Panel](exchange-gain-and-loss-calculator.md#calculator-configuration).
...
Once an account is Consolidated, users must not be able to Consolidate it again. Consolidated accounts must be presented appropriately.
{% endhint %}
