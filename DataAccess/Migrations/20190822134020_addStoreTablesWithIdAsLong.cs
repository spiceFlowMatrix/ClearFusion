...
{
    public partial class addStoreTablesWithIdAsLong : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseId = table.Column<long>(nullable: false),
                    Purchase = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseGenerators_StoreItemPurchases_PurchaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseVehicles_StoreItemPurchases_PurchaseId",
                        column: x => x.PurchaseId,
                        principalTable: "StoreItemPurchases",
                        principalColumn: "PurchaseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseGenerators_PurchaseId",
                table: "PurchaseGenerators",
                column: "PurchaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseVehicles_PurchaseId",
                table: "PurchaseVehicles",
                column: "PurchaseId");
