...
namespace HumanitarianAssistance.Service.interfaces
{
	public interface IVoucherDetail
	{
		...
		Task<APIResponse> GetAllLedgerDetailsByCondition(int? CurrencyId = 1, DateTime? fromdate = null, DateTime? todate = null, int? officeCode = null, int? AccountId = null, int? RecordType = 1);
