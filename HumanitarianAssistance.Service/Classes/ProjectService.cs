    ...
    public class ProjectService : IProject
    {
        ...
        public async Task<APIResponse> AddAreaDetails(AreaModel model, string UserId)
        {
            ...
            try
            {
                ...
                var data = await _uow.GetDbContext().AreaDetail.FirstOrDefaultAsync(x => x.IsDeleted == false && x.AreaName.Trim().ToLower() == model.AreaName.Trim().ToLower());

                if (data == null)
                {
                    AreaDetail obj = _mapper.Map<AreaModel, AreaDetail>(model);
                    var AreaDetail = await _uow.GetDbContext().AreaDetail
        ...
        public APIResponse GetAllProvinceDetailsByCountryId(int[] countryId)
        {
            APIResponse response = new APIResponse();
            try
            {
                var provincelist = _uow.GetDbContext().ProvinceDetails.Where(x => x.IsDeleted == false).ToList();
                var Newlist = provincelist.Where(x => countryId.Any(y => x.CountryId == y)).Select(x => new ProvinceDetailsModel
                {
                    ProvinceId = x.ProvinceId,
                    ProvinceName = x.ProvinceName
                }).OrderBy(x => x.ProvinceName).ToList();
        ...
        public APIResponse GetCountryMultiSelectByProjectId(long ProjectId)
        {
            ...
            try
            {
                ...
                List<int?> SelectedCountryList = _uow.GetDbContext().CountryMultiSelectDetails.Where(x => x.ProjectId == ProjectId && x.IsDeleted == false).Select(x => x.CountryId).ToList();
        ...
        public async Task<APIResponse> AddEditDonorCriteria(DonorCriteriaModel model, string UserId)
        {
            APIResponse response = new APIResponse();
            DonorCriteriaDetails _detail = new DonorCriteriaDetails();
            try
            {
                _detail = await _uow.GetDbContext().DonorCriteriaDetail.FirstOrDefaultAsync(x => x.ProjectId == model.ProjectId &&
                                                                                                 x.IsDeleted == false);
                if (_detail == null)
                {
                    ...
                    await _uow.DonorCriteriaDetailsRepository.AddAsyn(_detail);
                }
                else
                {
                    ...
                    await _uow.DonorCriteriaDetailsRepository.UpdateAsyn(_detail);
                    await _uow.GetDbContext().SaveChangesAsync();
                }
                response.StatusCode = StaticResource.successStatusCode;
                response.Message = "Success";
        ...
        public async Task<APIResponse> AddEditPurposeofInitiativeCriteria(PurposeofInitiativeCriteriaModel model, string UserId)
        {
            APIResponse response = new APIResponse();
            PurposeofInitiativeCriteria _detail = new PurposeofInitiativeCriteria();
            try
            {
                _detail = await _uow.GetDbContext().PurposeofInitiativeCriteria.FirstOrDefaultAsync(x => x.ProjectId == model.ProjectId &&
                                                                                                         x.IsDeleted == false);
                if (_detail == null)
                {
        ...
        public async Task<APIResponse> AddEditEligibilityCriteriaDetail(EligibilityCriteriaDetailModel model, string UserId)
        {
            APIResponse response = new APIResponse();
            EligibilityCriteriaDetail _detail = new EligibilityCriteriaDetail();
            try
            {
                _detail = await _uow.GetDbContext().EligibilityCriteriaDetail.FirstOrDefaultAsync(x => x.ProjectId == model.ProjectId &&
                                                                                             x.IsDeleted == false);
                if (_detail == null)
                {
                    ...
                    await _uow.EligibilityCriteriaDetailRepository.AddAsyn(_detail);
                }
                else
                {
                    ...
                    _detail.ModifiedById = UserId;
                    _detail.ModifiedDate = DateTime.UtcNow;
                    await _uow.EligibilityCriteriaDetailRepository.UpdateAsyn(_detail);
                    await _uow.GetDbContext().SaveChangesAsync();
                }
        ...
        public async Task<APIResponse> AddEditFeasibilityCriteria(FeasibilityCriteriaModel model, string UserId)
        {
            APIResponse response = new APIResponse();
            FeasibilityCriteriaDetail _detail = new FeasibilityCriteriaDetail();
            try
            {
                _detail = await _uow.GetDbContext().FeasibilityCriteriaDetail.FirstOrDefaultAsync(x => x.ProjectId == model.ProjectId &&
                                                                                                       x.IsDeleted == false);
                if (_detail == null)
                {
                    ...
                    await _uow.FeasibilityCriteriaDetailRepository.AddAsyn(_detail);
                }
                else
                {
                    ...
                    _detail.ModifiedById = UserId;
                    _detail.ModifiedDate = DateTime.UtcNow;
                    await _uow.FeasibilityCriteriaDetailRepository.UpdateAsyn(_detail);
                    _uow.GetDbContext().SaveChanges();
                }
                response.StatusCode = StaticResource.successStatusCode;
                response.Message = "Success";
        ...
        public async Task<APIResponse> AddEditPriorityCriteria(PriorityCriteriaModel model, string UserId)
        {
            APIResponse response = new APIResponse();
            PriorityCriteriaDetail _detail = new PriorityCriteriaDetail();
            try
            {
                _detail = await _uow.GetDbContext().PriorityCriteriaDetail.FirstOrDefaultAsync(x => x.ProjectId == model.ProjectId &&
                                                                                        x.IsDeleted == false);
                if (_detail == null)
                {
                    ...
                    await _uow.PriorityCriteriaDetailRepository.AddAsyn(_detail);
                }
                else
                {
                    ...
                    _detail.ModifiedById = UserId;
                    _detail.ModifiedDate = DateTime.UtcNow;
                    await _uow.PriorityCriteriaDetailRepository.UpdateAsyn(_detail);
                    await _uow.GetDbContext().SaveChangesAsync();
                }
                response.StatusCode = StaticResource.successStatusCode;
                response.Message = "Success";
        ...
        public async Task<APIResponse> AddEditFinancialCriteria(FinancialCriteriaModel model, string UserId)
        {
            APIResponse response = new APIResponse();
            FinancialCriteriaDetail _detail = new FinancialCriteriaDetail();
            try
            {
                _detail = await _uow.GetDbContext().FinancialCriteriaDetail.FirstOrDefaultAsync(x => x.ProjectId == model.ProjectId &&
                                                                                                     x.IsDeleted == false);
                if (_detail == null)
                {
                    ...
                    await _uow.FinancialCriteriaDetailRepository.AddAsyn(_detail);
                }
                else
                {
                    ...
                    _detail.ModifiedById = UserId;
                    _detail.ModifiedDate = DateTime.UtcNow;
                    await _uow.FinancialCriteriaDetailRepository.UpdateAsyn(_detail);
                    await _uow.GetDbContext().SaveChangesAsync();
                }
                response.StatusCode = StaticResource.successStatusCode;
                response.Message = "Success";
        ...
        public async Task<APIResponse> AddEditTargetBeneficiary(TargetBeneficiaryDetail model, string UserId)
        {
            APIResponse response = new APIResponse();
            TargetBeneficiaryDetail _detail = new TargetBeneficiaryDetail();
            try
            {
                _detail = await _uow.GetDbContext().TargetBeneficiaryDetail.FirstOrDefaultAsync(x => x.ProjectId == model.ProjectId &&
                ...
                if (_detail == null)
                {
                    ...
                    await _uow.TargetBeneficiaryDetailRepository.AddAsyn(_detail);
                }
                else
                {
                    ...
                    _detail.ModifiedById = UserId;
                    _detail.ModifiedDate = DateTime.UtcNow;
                    await _uow.TargetBeneficiaryDetailRepository.UpdateAsyn(_detail);
                    await _uow.GetDbContext().SaveChangesAsync();
                }
        ...
        public APIResponse AddEditFinancialProjectDetail(FinancialProjectDetailModel model, string UserId)
        {
            ...
            try
            {
                _detail = _uow.GetDbContext().FinancialProjectDetail.FirstOrDefault(x => x.ProjectId == model.ProjectId &&
                                                                                         x.FinancialProjectDetailId == model.FinancialProjectDetailId &&
                                                                                         x.IsDeleted == false);
                if (_detail == null)
                {
        ...
        public async Task<APIResponse> AddPriorityOtherDetail(CEPriorityDetailModel model, string UserId)
        {
            ...
            try
            {
                ...
                {
                    PriorityOtherDetailId = model.PriorityOtherDetailId.Value,
                    Name = model.Name,
                    ProjectId = model.ProjectId,
                    IsDeleted = false,
                    CreatedById = UserId,
        ...
        public async Task<APIResponse> AddFeasibilityExpertDetail(CEFeasibilityExpertOtherModel model, string UserId)
        {
            ...
            try
            {
                ...
                {
                    ExpertOtherDetailId = model.ExpertOtherDetailId.Value,
                    Name = model.Name,
                    ProjectId = model.ProjectId,
                    IsDeleted = false,
                    CreatedById = UserId,
        ...
        public async Task<APIResponse> EditFeasibilityExpertDetail(CEFeasibilityExpertOtherModel model, string UserId)
        {
            ...
            try
            {
                CEFeasibilityExpertOtherDetail _detail = await _uow.GetDbContext().CEFeasibilityExpertOtherDetail.FirstOrDefaultAsync(x => x.ExpertOtherDetailId == model.ExpertOtherDetailId
                                                                                                                                        && x.IsDeleted == false);
                if (_detail != null)
                {
                    _detail.Name = model.Name;
        ...
        public async Task<APIResponse> AddAgeGroupDetail(CEAgeGroupDetailModel model, string UserId)
        {
            ...
            try
            {
                ...
                {
                    AgeGroupOtherDetailId = model.AgeGroupOtherDetailId.Value,
                    Name = model.Name,
                    ProjectId = model.ProjectId,
                    IsDeleted = false,
                    CreatedById = UserId,
        ...
        public async Task<APIResponse> EditAgeGroupDetail(CEAgeGroupDetailModel model, string UserId)
        {
            ...
            try
            {
                CEAgeGroupDetail _detail = await _uow.GetDbContext().CEAgeGroupDetail.FirstOrDefaultAsync(x => x.AgeGroupOtherDetailId == model.AgeGroupOtherDetailId &&
                                                                                                               x.IsDeleted == false);
                if (_detail != null)
                {
                    _detail.Name = model.Name;
        ...
        public async Task<APIResponse> GetAllOccuopationList()
        {
            ...
            try
            {
                var list = await _uow.GetDbContext().CEOccupationDetail.Where(x => x.IsDeleted == false)
                                                                                .OrderByDescending(x => x.OccupationOtherDetailId)
                                                                                .ToListAsync();
        ...
        public async Task<APIResponse> AddOccupationOtherDetail(CEOccupationDetailModel model, string UserId)
        {
            ...
            try
            {
                ...
                {
                    OccupationOtherDetailId = model.OccupationOtherDetailId.Value,
                    Name = model.Name,
                    ProjectId = model.ProjectId,
                    IsDeleted = false,
                    CreatedById = UserId,
        ...
        public async Task<APIResponse> EditOccupationOtherDetail(CEOccupationDetailModel model, string UserId)
        {
            ...
            try
            {
                CEOccupationDetail _detail = await _uow.GetDbContext().CEOccupationDetail.FirstOrDefaultAsync(x => x.OccupationOtherDetailId == model.OccupationOtherDetailId &&
                                                                                                                   x.IsDeleted == false);
                if (_detail != null)
                {
                    _detail.Name = model.Name;
        ...
        public async Task<APIResponse> AddAssumptionDetail(CEAssumptionDetailModel model, string UserId)
        {
            ...
            try
            {
                ...
                {
                    AssumptionDetailId = model.AssumptionDetailId.Value,
                    Name = model.Name,
                    ProjectId = model.ProjectId,
                    IsDeleted = false,
                    CreatedById = UserId,
        ...
        public async Task<APIResponse> EditAssumptionDetail(CEAssumptionDetailModel model, string UserId)
        {
            ...
            try
            {
                CEAssumptionDetail _detail = await _uow.GetDbContext().CEAssumptionDetail.FirstOrDefaultAsync(x => x.AssumptionDetailId == model.AssumptionDetailId &&
                                                                                                                   x.IsDeleted == false);
                if (_detail != null)
                {
                    _detail.Name = model.Name;
        ...
        public async Task<APIResponse> AddDonorEligibilityOtherDetail(DonorEligibilityCriteriaModel model, string UserId)
        {
            ...
            try
            {
                ...
                {
                    DonorEligibilityDetailId = model.DonorEligibilityDetailId.Value,
                    Name = model.Name,
                    ProjectId = model.ProjectId,
                    IsDeleted = false,
                    CreatedById = UserId,
        ...
        public async Task<APIResponse> EditDonorEligibilityOtherDetail(DonorEligibilityCriteriaModel model, string UserId)
        {
            ...
            try
            {
                DonorEligibilityCriteria _detail = await _uow.GetDbContext().DonorEligibilityCriteria.FirstOrDefaultAsync(x => x.DonorEligibilityDetailId == model.DonorEligibilityDetailId &&
                                                                                                                               x.IsDeleted == false);
                if (_detail != null)
                {
                    _detail.Name = model.Name;
        ...
        #region "Criteria evaluation form approved status"
        public async Task<APIResponse> GetIsApprovedCriteriaEvaluationStatus(long projectId)
        {
            APIResponse response = new APIResponse();
                ...
                if (model.ProjectId != 0)
                {
                    ...
                    if (model.ProjectJobId == 0)
                    {
                        ...
                        if (obj.ProjectJobId != 0)
                        {
                            ...
                            obj.ProjectJobCode = await GetProjectJobCode(obj);
                    ...
                    {
                        ProjectJobDetail projectJobDetail = await _uow.GetDbContext().ProjectJobDetail.FirstOrDefaultAsync(x => x.IsDeleted == false &&
                                                                                                                                x.ProjectJobId == model.ProjectJobId);
        ...
        public async Task<APIResponse> GetAllProjectJobDetail()
        {
            ...
            try
            {
                ...
                var list = await _uow.GetDbContext().ProjectJobDetail.Where(x => x.IsDeleted == false)
        ...
        public async Task<APIResponse> GetAllProjectJobByProjectId(long projectJobId)
        {
            ...
            try
            {
                if (projectJobId != 0)
                {
                    var JobDertailList = await _uow.GetDbContext().ProjectJobDetail.Where(x => x.IsDeleted == false &&
                                                                                               x.ProjectJobId == projectJobId)
        ...
        public async Task<APIResponse> GetAllProjectJobsFilterList(ProjectJobFilterModel projectJobFilterModel)
        {
            ...
            try
            {
                ...
                int totalCount = await _uow.GetDbContext().ProjectJobDetail.Where(x => x.IsDeleted == false &&
                                                                                       x.ProjectId == projectJobFilterModel.ProjectId)
                                                                                 .CountAsync();
        ...
        public async Task<APIResponse> GetProjectJobDetailByBudgetLineId(long budgetLineId)
        {
            ...
            try
            {
                ...
                ProjectBudgetLineDetail projectBudgetLineDetail = await _uow.GetDbContext().ProjectBudgetLineDetail
        ...
        public async Task<APIResponse> AddEditProjectBudgetLineDetail(ProjectBudgetLineDetailModel model, string UserId)
        {
            ...
            try
            {
                ...
                {
                    ProjectBudgetLineDetail projectBudgetLineDetail = _uow.GetDbContext().ProjectBudgetLineDetail.FirstOrDefault(x => x.IsDeleted == false &&
                                                                                                                                      x.BudgetLineId == model.BudgetLineId);
        ...
        public async Task<APIResponse> GetallBudgetLineDetail()
        {
            ...
            try
            {
                var budgetList = await Task.Run(() => _uow.GetDbContext()
                ...
                List<ProjectBudgetLineDetailModel> budgetDetaillist = budgetList.Select(b => new ProjectBudgetLineDetailModel
                {
        ...
        public async Task<APIResponse> GetallBudgetLineDetail(long projectId)
        {
            ...
            try
            {
                List<ProjectBudgetLineDetail> budgetList = await _uow.GetDbContext().ProjectBudgetLineDetail
        ...
        public async Task<APIResponse> GetBudgetLinesByMultipleProjectJobIds(List<long?> projectJobIds)
        {
            ...
            try
            {
                var list = await _uow.GetDbContext().ProjectBudgetLineDetail.Where(x => x.IsDeleted == false && projectJobIds.Contains(x.ProjectJobId))
                                                                      .Select(x => new ProjectBudgetLineDetailModel
                                                                      {
                                                                          BudgetCode = x.BudgetCode,
