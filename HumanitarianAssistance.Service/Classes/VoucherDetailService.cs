    ...
    public class VoucherDetailService : IVoucherDetail
    {
        ...
        public async Task<APIResponse> GetAllVoucherTransactionDetailByVoucherNo(int VoucherNo)
        {
            ...
            try
            {
                ...
                var transactionlist = await _uow.GetDbContext().VoucherTransactions.Include(x => x.CreditAccountDetails).Where(x => x.VoucherNo == VoucherNo && x.IsDeleted == false).ToListAsync();
        ...
        public async Task<APIResponse> EditVoucherTransactionDetail(VoucherTransactionModel model)
        {
            ...
            try
            {
                ...
                {
                    var exchangeRate = await _uow.GetDbContext().ExchangeRates.Where(x => x.OfficeCode == "KBL").OrderByDescending(x => x.Date).ToListAsync();
                    ...
                    //In-Use
                    vouchertransactionInfo.AccountNo = model.AccountNo;
        ...
        public async Task<APIResponse> GetAllLedgerDetailsByCondition(LedgerModels model)
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    ...
                    ICollection<ChartAccountDetail> accountDetail = await _uow.ChartAccountDetailRepository.FindAllAsync(x => x.IsDeleted == false && model.accountLists.Contains(x.AccountCode));
                ...
                var ledgerByAccount = closingLedgerList.GroupBy(x => x.AccountCode).ToList();
        ...
        public async Task<APIResponse> GetTrailBlanceDetailsByCondition(LedgerModels model)
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    ...
                    if (model.RecordType == 1)
                    {
                        List<LedgerModel> transactionDetail = null;
                        ...
                        foreach (var accountItem in accountDetail)
                        {
                            ...
                            {
                                // Gets the fourth level accounts  
                                accountLevel4 = await _uow.ChartAccountDetailRepository.FindAllAsync(x => accountItem.AccountCode == x.AccountCode && x.AccountLevelId == 4);
                                List<long> accountLeve4List = accountLevel4.Select(x => x.ChartOfAccountCode).ToList();
                                ...
                                transactionDetail = await _uow.GetDbContext().VoucherTransactions
                                                                  .Join(_uow.GetDbContext().CurrencyDetails,
                                                                    ...
                                                                    .Join(_uow.GetDbContext().ChartAccountDetail,
                                                                           Vt => Vt.VoucherT.AccountNo, //Primary
                                                                           Ch => Ch.AccountCode, //Foreign
                                                                          (Vt, Ch) => new
                                                                          {
                                                                              VoucherT = Vt,
                                                                              ChartD = Ch
                                                                  ...
                                                                  .Where(x => x.VoucherT.VoucherT.IsDeleted == false &&
                                                                              accountLeve4List.Contains(x.VoucherT.VoucherT.AccountNo.Value) && //x.AccountNo == accountItem.AccountCode &&
                                                                   ...
                                                                   {
                                                                       AccountCode = item.VoucherT.VoucherT.AccountNo.Value,
                                ...
                                //transactionDetail = await _uow.VoucherTransactionsRepository
                                //                             .FindAllAsync(x => x.IsDeleted == false &&
                                //                                              x.AccountNo == accountItem.AccountCode &&
                            ...
                            {
                                // Gets the fourth level accounts
                                accountLevel4 = await _uow.ChartAccountDetailRepository.FindAllAsync(x => x.ParentID == accountItem.AccountCode && x.AccountLevelId == 4);
                                List<long> accountLeve4List = accountLevel4.Select(x => x.ChartOfAccountCode).ToList();
                            ...
                            {
                                // Gets the third level accounts
                                accountLevel3 = await _uow.GetDbContext().ChartAccountDetail.Where(x => x.ParentID == accountItem.AccountCode && x.AccountLevelId == 3).Select(x => x.ChartOfAccountCode).ToListAsync();
                                // Gets the fourth level accounts
                                accountLevel4 = await _uow.ChartAccountDetailRepository.FindAllAsync(x => x.AccountLevelId == 4 && accountLevel3.Contains(x.ParentID));
                            ...
                            {
                                // Gets the second level accounts
                                accountLevel2 = await _uow.GetDbContext().ChartAccountDetail.Where(x => x.ParentID == accountItem.AccountCode && x.AccountLevelId == 2).Select(x => x.ChartOfAccountCode).ToListAsync();

                                // Gets the level 3rd accounts
                                accountLevel3 = await _uow.GetDbContext().ChartAccountDetail.Where(x => accountLevel2.Contains(x.ParentID) && x.AccountLevelId == 3).Select(x => x.ChartOfAccountCode).ToListAsync();

                                // Gets the fourth level accounts
                                accountLevel4 = await _uow.ChartAccountDetailRepository.FindAllAsync(x => accountLevel3.Contains(x.ParentID) && x.AccountLevelId == 4);
        ...
        public async Task<APIResponse> GetBlanceSheetDetails(FinancialReportModel model)
        {
            ...
            try
            {
                ...
                ChartAccountDetail accountDetails = null;

                List<BalanceSheetModel> lstBalanceSheetModel = new List<BalanceSheetModel>();
                foreach (var items in cpList)
                {

                    accountDetails = allAccounts.Find(x => x.ChartOfAccountCode == items.ChartOfAccountCode);       // Just used for finding the details of this account
        ...
        public async Task<APIResponse> GetDetailsOfNotesReportData(int? financialyearid, int? currencyid)
        {
            ...
            try
            {
                if (financialyearid != null && currencyid != null)
                {
                    ...
                    var allAccounts = await _uow.GetDbContext().ChartAccountDetail.Include(x => x.CreditAccountlist)
                        .Select(x => new
                        {
                            AccountCode = x.AccountCode,
                            AccountLevelId = x.AccountLevelId,
            ...
            try
            {
                ICollection<VoucherDetail> vouchers = await _uow.VoucherDetailRepository
                                                        .FindAllAsync(x =>
                                                                        ...
                                                                        x.OfficeId == JournalVoucherFilter.OfficeId &&
        ...
        public async Task<APIResponse> AddExchangeGainLossVoucher(ExchangeGainLossVoucher model)
        {
            ...
            try
            {
                ...
                VoucherTransactionModel xVoucherTransactionModel = new VoucherTransactionModel();
                // for Credit
                ...
                xVoucherTransactionModel.CurrencyId = model.CurrencyId;
                xVoucherTransactionModel.Description = model.Description;
                ...
                if (xAPIResponse.StatusCode == 200)
                {
                    ...
                    xVoucherTransactionModel.AccountNo = model.AccountCodeDebit;
                    xVoucherTransactionModel.DebitAccount = model.AccountCodeDebit;
        ...
        public async Task<APIResponse> AddEmployeePensionPayment(EmployeePensionPaymentModel EmployeePensionPayment)
        {
            ...
            try
            {
                ...
                xVoucherTransactionModel.Debit = 0;
                xVoucherTransactionModel.CurrencyId = EmployeePensionPayment.CurrencyId;
                xVoucherTransactionModel.Description = string.Format(StaticResource.PensionPaymentCreated, DateTime.Now.Date, EmployeeDetails.EmployeeName); ;
