...
{
    public class UpdateInvoiceCommandHandler : IRequestHandler<UpdateInvoiceCommand, ApiResponse>
    {
        private HumanitarianAssistanceDbContext _dbContext;
        public UpdateInvoiceCommandHandler(HumanitarianAssistanceDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public async Task<ApiResponse> Handle(UpdateInvoiceCommand request, CancellationToken cancellationToken)
        {
