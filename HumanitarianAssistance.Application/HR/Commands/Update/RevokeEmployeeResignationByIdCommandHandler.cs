...
{
    public class RevokeEmployeeResignationByIdCommandHandler : IRequestHandler<RevokeEmployeeResignationByIdCommand, object>
    {
        private readonly HumanitarianAssistanceDbContext _dbContext;
        public RevokeEmployeeResignationByIdCommandHandler(HumanitarianAssistanceDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public async Task<object> Handle(RevokeEmployeeResignationByIdCommand request, CancellationToken cancellationToken)
        {
            bool success = false;
            ...
            try
            {
                ...
                if (resignationDetail == null)
                {
                    ...
                    if (empDetail != null) 
                    {
                        ...
                        empDetail.ResignationStatus = (int)ResignationStatus.ResignationRevoked;
                    }
                }
                else 
                {
                    ...
                    resignationDetail.EmployeeDetail.ResignationStatus = (int)ResignationStatus.ResignationRevoked;
