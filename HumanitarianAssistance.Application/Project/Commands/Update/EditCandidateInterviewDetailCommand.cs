...
namespace HumanitarianAssistance.Application.Project.Commands.Update {
    public class EditCandidateInterviewDetailCommand : BaseModel, IRequest<ApiResponse> {
        public List<InterviewQuestionModel> RatingBasedCriteriaList { get; set; }
        public List<InterviewQuestionModel> TechnicalQuestionList { get; set; }
