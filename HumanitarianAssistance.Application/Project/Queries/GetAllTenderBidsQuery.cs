...
{
    public class GetAllTenderBidsQuery: IRequest<ApiResponse>
    {
        public long RequestId {get; set;}
    }

    public class TenderBidsModel 
    {
        ...
        public string ContractLetterName { get; set; }
        public string ContractLetterUrl { get; set; }
