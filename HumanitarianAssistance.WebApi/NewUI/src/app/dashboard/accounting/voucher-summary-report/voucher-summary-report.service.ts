...
export class VoucherSummaryReportService {
    ...
    return this.globalService
      .post(
        this.appurl.getApiUrl() +
          GLOBAL.API_AccountReports_GetVoucherSummaryReportList,
        data
      )
      .pipe(
        map(x => {
  ...
  voucherTransactionList(data: any) {
    return this.globalService
      .post(
        this.appurl.getApiUrl() +
          GLOBAL.API_AccountReports_GetVoucherTransactionList,
        data
      )
      .pipe(
        map(x => {
  ...
  getProjectJobList(projectIds: number[]) {
    return this.globalService
      .post(
        this.appurl.getApiUrl() + GLOBAL.API_Project_GetProjectJobsByProjectIds,
        projectIds
      )
      .pipe(
        map(x => {
  ...
  getProjectBudgetLineList(projectJobIds: number[]) {
    return this.globalService
      .post(
        this.appurl.getApiUrl() +
          GLOBAL.API_Project_GetProjectBudgetLinesByProjectJobIds,
        projectJobIds
      )
      .pipe(
        map(x => {
