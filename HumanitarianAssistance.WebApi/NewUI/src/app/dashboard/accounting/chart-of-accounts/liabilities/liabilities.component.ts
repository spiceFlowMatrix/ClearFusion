...
import { AccountHeadTypes_Enum, AccountLevelLimits, AccountLevels } from '../../../../shared/enum';
...
export class LiabilitiesComponent implements OnInit {
  ...
  pageId = ApplicationPages.Liabilities;
  ...
  editMainLevelAccountDetail(model: ChartOfAccountModel) {
    ...
    // Error handling and loading handling
    const item = this.chartOfAccountList.find(
      x => x.ChartOfAccountNewId === model.ChartOfAccountNewId
    );
  ...
  addControlLevelAccountDetail(mainLevelData: ChartOfAccountModel, model: any) {
    // Main Level
    const mainLevelItem = this.chartOfAccountList.find(
      x => x.ChartOfAccountNewId === mainLevelData.ChartOfAccountNewId
    );
    const mainLevelIndex = this.chartOfAccountList.indexOf(mainLevelItem);
  ...
  editControlLevelAccountDetail(
    ...
    // Error handling and loading handling
    const item = this.chartOfAccountList[mainLevelIndex].Children.find(
      x => x.ChartOfAccountNewId === model.ChartOfAccountNewId
    );
    const index = this.chartOfAccountList[mainLevelIndex].Children.indexOf(
      item
    );
    this.chartOfAccountList[mainLevelIndex].Children[index]._IsLoading = true;
    this.chartOfAccountList[mainLevelIndex].Children[index]._IsError = false;
  ...
  addSubLevelAccountDetail(
    ...
    const controlLevelItem = this.chartOfAccountList[
      ...
      x => x.ChartOfAccountNewId === controlLevelData.ChartOfAccountNewId
    );
    const controlLevelIndex = this.chartOfAccountList[
      mainLevelIndex
    ].Children.indexOf(controlLevelItem);
    ...
    const count =
      this.chartOfAccountList[mainLevelIndex].Children[controlLevelIndex]
        .Children.length - 1;
    if (count < AccountLevelLimits.SubLevel) {
      ...
      const index =
        this.chartOfAccountList[mainLevelIndex].Children[controlLevelIndex]
          .Children.length - 1; // use to calculate the index
      this.chartOfAccountList[mainLevelIndex].Children[
        controlLevelIndex
      ].Children[index]._IsLoading = true;
      this.chartOfAccountList[mainLevelIndex].Children[
        controlLevelIndex
      ].Children[index]._IsError = false;
        ...
        .subscribe(
          response => {
            if (response.StatusCode === 200) {
              ...
              this.chartOfAccountList[mainLevelIndex].Children[
                controlLevelIndex
              ].Children[index]._IsLoading = false;
              this.chartOfAccountList[mainLevelIndex].Children[
                controlLevelIndex
              ].Children[index]._IsError = true;
            } else {
              // Error Handling
              this.chartOfAccountList[mainLevelIndex].Children[
                controlLevelIndex
  ...
  editSubLevelAccountDetail(
    ...
    // Error handling and loading handling
    const item = this.chartOfAccountList[mainLevelIndex].Children[
      controlLevelIndex
    ].Children.find(x => x.ChartOfAccountNewId === model.ChartOfAccountNewId);
  ...
  addInputLevelAccountDetail(
    ...
    // Sub Level
    const subLevelItem = this.chartOfAccountList[mainLevelIndex].Children[
      controlLevelIndex
    ].Children.find(
      x => x.ChartOfAccountNewId === subLevelData.ChartOfAccountNewId
    );
    const subLevelIndex = this.chartOfAccountList[mainLevelIndex].Children[
      controlLevelIndex
    ].Children.indexOf(subLevelItem);

    const count =
      this.chartOfAccountList[mainLevelIndex].Children[controlLevelIndex]
        .Children[subLevelIndex].Children.length - 1;
    if (count < AccountLevelLimits.InputLevel) {
      ...
      this.chartOfAccountList[mainLevelIndex].Children[
        controlLevelIndex
      ].Children[subLevelIndex].Children.push(obj);

      // Error handling and loading handling
      const index =
        this.chartOfAccountList[mainLevelIndex].Children[controlLevelIndex]
          .Children[subLevelIndex].Children.length - 1; // use to calculate the index
      this.chartOfAccountList[mainLevelIndex].Children[
        controlLevelIndex
      ].Children[subLevelIndex].Children[index]._IsLoading = true;
      this.chartOfAccountList[mainLevelIndex].Children[
        controlLevelIndex
      ].Children[subLevelIndex].Children[index]._IsError = false;
          ...
          response => {
            if (response.StatusCode === 200) {
              if (response.data.ChartOfAccountNewDetail !== null) {
                ...
                this.chartOfAccountList[mainLevelIndex].Children[
                  controlLevelIndex
                ].Children[subLevelIndex].Children[index] = obj;
              ...
              this.chartOfAccountList[mainLevelIndex].Children[
                controlLevelIndex
              ].Children[subLevelIndex].Children[index]._IsLoading = false;
              this.chartOfAccountList[mainLevelIndex].Children[
                controlLevelIndex
              ].Children[subLevelIndex].Children[index]._IsError = true;
            } else {
              // Error Handling
              this.chartOfAccountList[mainLevelIndex].Children[
                controlLevelIndex
  ...
  editInputLevelAccountDetail(
    ...
    const item = this.chartOfAccountList[mainLevelIndex].Children[
      controlLevelIndex
    ].Children[subLevelIndex].Children.find(
      x => x.ChartOfAccountNewId === model.ChartOfAccountNewId
    );
    const index = this.chartOfAccountList[mainLevelIndex].Children[
      controlLevelIndex
    ].Children[subLevelIndex].Children.indexOf(item);
  ...
  onAddInputLevelAccount(
    ...
    this.addInputLevelAccountDetail(
      mainLevelData,
      controlLevelData,
      subLevelData,
      obj
  ...
  onBlurEditSubLevelAccountName(
    ...
    if (data !== '') {
      ...
      this.editSubLevelAccountDetail(
        mainLevelData,
        controlLevelData,
        subLevelDetail
      );
  ...
  onBlurEditInputLevelAccountName(
    ...
    if (data !== '') {
      ...
      this.editInputLevelAccountDetail(
        mainLevelData,
        controlLevelData,
        subLevelData,
        subLevelDetail
