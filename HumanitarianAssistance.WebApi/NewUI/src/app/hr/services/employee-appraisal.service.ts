...
export class EmployeeAppraisalService {
    ...
    return this.globalService
      .getListById(
        this.appurl.getApiUrl() +
          GLOBAL.API_EmployeeDetail_GetEmployeeAppraisalByEmployeeId , id
      );
  }
  ...
  GetAppraisalQuestions() {
    ...
    .getList(
      this.appurl.getApiUrl() +
        GLOBAL.API_Code_GetAppraisalQuestions
    );
  }
  ...
  getfilteredEmployeeList(data: any) {
    ...
    .post(
      this.appurl.getApiUrl() +
        GLOBAL.API_EmployeeDetail_GetFilteredEmployeeList, data
    );
  }
