...
@Component({
  selector: 'app-procurement-items',
  templateUrl: './procurement-items.component.html',
  styleUrls: ['./procurement-items.component.css']
})
export class ProcurementItemsComponent implements OnInit {
