...
import { FileSourceEntityTypes, DocumentFileTypes } from '../../../../shared/enums';
...
export class PurchasesComponent implements OnInit {
    ...
    selectedImageDocumentId: number;
    ...
    onPurchaseInvoiceSelect(eventInvoice) {
        ...
        if (eventInvoice.value != null && eventInvoice.value.length > 0) {
    ...
    onImageSelectUpdate(event: any, rowData) {
        ...
        if (this.flag === 0) {
            ...
            this.selectedImageDocumentId = rowData.data.ImageDocumentId;
            this.selectedInvoiceDocumentId = rowData.data.InvoiceDocumentId;
